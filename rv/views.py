...
class ListCreateApiView(generics.ListCreateAPIView):
    ...
    #--- pour la classe serializer
    serializer_class = PersonneSerializer
   
    # #-----POUR LES PERMISSIONS-----------
    permission_classes= [permissions.IsAuthenticatedOrReadOnly,permissions.IsAuthenticated,permissions]
...
class ListAPIView(generics.ListAPIView):
    ...
    def get_queryset(self):
        return super().get_queryset().filter(name_icontains='past')
    

class PersonneMixinsViews(generics.GenericAPIView, 
